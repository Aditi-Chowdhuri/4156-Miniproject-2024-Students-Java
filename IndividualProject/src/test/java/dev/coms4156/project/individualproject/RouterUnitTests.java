...
public class RouterUnitTests {
        ...
        public void changeCourseLocationTest() {
                ...
                Assertions.assertEquals(HttpStatus.OK, testrouteController.changeCourseLocation("COMS", 1004, "401 Mudd").getStatusCode());
                Assertions.assertEquals("Attributed was updated successfully.", testrouteController.changeCourseLocation("COMS", 1004, "401 Mudd").getBody());

                Assertions.assertTrue(testrouteController.findCourseLocation("COMS", 1004).getBody().toString().contains("401 Mudd"));
        }
        @Test
        public void changeCourseTimeTest() {
                
                Assertions.assertEquals(HttpStatus.OK, testrouteController.changeCourseTime("COMS", 1004, "10:10-11:30").getStatusCode());
                Assertions.assertEquals("Attributed was updated successfully.", testrouteController.changeCourseTime("COMS", 1004, "10:10-11:30").getBody());

                Assertions.assertTrue(testrouteController.findCourseTime("COMS", 1004).getBody().toString().contains("10:10-11:30"));
        }
